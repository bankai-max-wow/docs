...
<Note>
  Enter your API key in the **Authentication** field at the top of each endpoint page to send live requests. All calls go to `https://samurai-ai.com/v1`.
</Note>
...
Get your API key from the [Dashboard](https://samurai-ai.com/dashboard).
