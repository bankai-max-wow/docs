...
| `402` | `insufficient_credits` | PAYG credit balance is $0.00 | Add credits at [dashboard/billing](https://samurai-ai.com/dashboard/billing) |
...
<AccordionGroup>
  <Accordion title="401 — Invalid API Key">
    ...
    **Causes & Fixes:**
    - Key starts with `sk-samurai-` but was revoked → Create a new key in the [dashboard](https://samurai-ai.com/dashboard)
  ...
  <Accordion title="402 — Insufficient Credits">
    ...
    **Fix:**
    1. Go to [Dashboard → Billing](https://samurai-ai.com/dashboard/billing)
  ...
  <Accordion title="403 — Permission Denied">
    ...
    **Fix:** Upgrade at [Dashboard → Billing](https://samurai-ai.com/dashboard/billing)
  </Accordion>
